...
JuliaVader is a port of the Valence Aware Dictionary and sEntiment Reasoner **(VADER)** that originally implemented in Python; [Original Author's Code](https://github.com/cjhutto/vaderSentiment). 
